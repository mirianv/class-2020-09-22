...
*define what we  want to know: classes with high change between enrollment at the beginning of the semester and today.

*See if we can draw parallels between classes that all had that characteristic

*Which week saw the most students drop a class


After we have a model, Temperance suggests we should:

*The reasons for dropping class are not listed

*We may not see a clear trend. 
